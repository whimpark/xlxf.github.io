import{_ as s,o as n,c as a,S as l}from"./chunks/framework.93883beb.js";const d=JSON.parse('{"title":"Home Page","description":"","frontmatter":{},"headers":[],"relativePath":"reference/default-theme-home-page.md","filePath":"reference/default-theme-home-page.md","lastUpdated":null}'),p={name:"reference/default-theme-home-page.md"},o=l(`<h1 id="home-page" tabindex="-1">Home Page <a class="header-anchor" href="#home-page" aria-label="Permalink to &quot;Home Page&quot;">​</a></h1><p>VitePress default theme provides a homepage layout, which you can also see used on <a href="./../">the homepage of this site</a>. You may use it on any of your pages by specifying <code>layout: home</code> in the <a href="./frontmatter-config">frontmatter</a>.</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">---</span></span>
